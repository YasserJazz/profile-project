...
<!--========== SLIDER ==========-->
<div class="promo-block parallax-window" data-parallax="scroll" data-image-src="{{ asset('assets/img/1920x1080/01.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <ul class="list-inline">
                    ...
                    <li><a href="https://www.behance.net/keenthemes" class="social-icons"><i class="icon-social-behance"></i></a></li>
